...
PATH_TURN_ON_SH="/etc/profile.d/SSL.sh"
...
installapp() {
    ...
    colorEcho ${GREEN} "开始安装SSLproxy_${VERSION}"
    ...
    wget -P $PATH_KT "${DOWNLOAD_HOST}/SSLproxy_${VERSION}_linux" -O "${PATH_KT}/${PATH_EXEC}" 1>/dev/null
...
echo ""
echo "项目地址:https://github.com/SSLminerProxy/SSLproxy"
echo "1、安装"
echo "2、更新"
echo "3、还是更新"
echo "4、启动"
